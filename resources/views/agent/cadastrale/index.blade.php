<x-layout>
        ...
        <nav class="w-64 bg-emerald-900 text-white p-4 space-y-4">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('profil') }}" class="flex items-center px-4 py-2 rounded transition duration-300 hover:bg-yellow-600">
            ...
            <div class="container mx-auto space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <h3 class="text-xl font-bold mb-2 mt-3">Nombre Total de demandes</h3>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        <span class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="45px" class="size-10" viewBox="0 -960 960 960" width="45px" fill="#5f6368">
                                ...
                                <p class="ml-4 text-3xl">{{ $totalExtraits }}</p>
                        </span>
                        <h3 class="text-xl font-bold mb-2 mt-3">Demande d'extrait de Plan</h3>
                        <p class="text-sm">Accéder aux demandes d'extrait de plan cadastrale</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        <span class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="45px" class="size-10" viewBox="0 -960 960 960" width="45px" fill="#5f6368">
                                ...
                                <p class="ml-4 text-3xl">{{ $totalBails }}</p>
                        </span>
                        <h3 class="text-xl font-bold mb-2 mt-3">Demandes de Bail</h3>
                        <p class="text-sm">Voir et gérer les demandes de bail en cours</p>
                    </div>
                    <div class="bg-white p-4 rounded-lg shadow-md">
                        ...
                        <tbody class="text-gray-700 bg-white">
                            ...
                            <tr class="even:bg-gray-50">
                                ...
                                <td class="whitespace-nowrap py-4 px-3 text-sm">
                                    <a href="{{ route('cadastrale.show', $dossier->id) }}" target="_blank" class="text-indigo-600 hover:text-emerald-400">Voir</a>
                                </td>
