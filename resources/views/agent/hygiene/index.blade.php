                ...
                <table class="min-w-full bg-white divide-y divide-gray-300">
                    ...
                    <tbody class="text-gray-700 bg-white">
                        ...
                        <tr class="even:bg-gray-50">
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-sm text-gray-900">{{ $dossier->parcelle->lotissement->localite->nom }}</td>
                            ...
                            <td class="whitespace-nowrap py-4 px-3 text-sm">
                                <a href="{{ route('hygiene.show', $dossier->id) }}" target="_blank" class="text-indigo-600 hover:text-emerald-400">Voir</a>
                            </td>
